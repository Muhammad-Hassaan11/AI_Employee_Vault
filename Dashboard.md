...
- [LINKEDIN_2026-07-14_machine-learning](Pending_Approval/LINKEDIN_2026-07-14_machine-learning.md) — LinkedIn post draft on machine learning for small businesses (scheduled 2026-07-14). Flip `status: pending` to `approved`/`rejected`.
- [LINKEDIN_human_in_the_loop_approval](Pending_Approval/LINKEDIN_human_in_the_loop_approval.md) — LinkedIn post draft "Behind the scenes: our human-in-the-loop AI approval system" (scheduled 2026-07-14, from Content_Calendar). Flip `status: pending` to `approved`/`rejected`.
- [FACEBOOK_2026-07-14_machine-learning](Pending_Approval/FACEBOOK_2026-07-14_machine-learning.md) — Facebook post draft on machine learning for small businesses (scheduled 2026-07-14). Flip `status: pending` to `approved`/`rejected`.
- [INSTAGRAM_2026-07-14_machine-learning](Pending_Approval/INSTAGRAM_2026-07-14_machine-learning.md) — Instagram post draft on machine learning for small businesses (scheduled 2026-07-14). Flip `status: pending` to `approved`/`rejected`.
- [INSTAGRAM_2026-07-15_day-in-the-life-ai-employee](Pending_Approval/INSTAGRAM_2026-07-15_day-in-the-life-ai-employee.md) — already APPROVED, scheduled 2026-07-15 13:00; will publish when the approval executor next runs at/after that time.
- [INSTAGRAM_2026-07-15_human-in-the-loop](Pending_Approval/INSTAGRAM_2026-07-15_human-in-the-loop.md) — already APPROVED, scheduled 2026-07-15 18:00; will publish when the approval executor next runs at/after that time.

*(Note: the previously-listed 7-day IG/FB content calendar batch, the Python-language FB/IG posts, and four earlier LinkedIn drafts are no longer in /Pending_Approval — they were resolved in prior runs; this list now reflects the folder's actual current contents.)*

## Recent Activity

- 2026-07-14 (local): Triaged 29 tasks claimed into /In_Progress/local — 28 gmail (13 Facebook Groups join notifications, 6 course/learning promos [Udemy x2, CodeAlpha, Alison, DataCamp, CodeRabbit], 2 Duolingo reminders, 2 Reddit digests, 1 Apollo policy notice, 1 Vibiz cold sales pitch, 1 Twilio marketing nudge, 1 GitHub third-party OAuth security notice) + 1 LinkedIn content-calendar post. All informational emails needed no reply and were closed to /Done; the GitHub OAuth notice was flagged in Alerts for owner verification; the LinkedIn post "Behind the scenes: our human-in-the-loop AI approval system" was drafted and saved to /Pending_Approval (process-task + linkedin-post skills)
...
- **GitHub third-party OAuth app authorized (owner action)**: GitHub reports a third-party OAuth application ("AgentRouter", user:email scope) was authorized on the Muhammad-Hassaan11 account on 2026-07-13 22:45 PDT. If this was you, no action needed. If not, revoke it at https://github.com/settings/connections/applications/Ov23lidtiR4LeVZvVRNL and review https://github.com/settings/security-log.
...
- **Meta (Facebook/Instagram) access token EXPIRED** (OAuthException 190, expired 2026-07-11 05:00 PDT): earlier posts failed to publish for this reason. Verify the token has been refreshed in Meta Business settings and `.env` before the two APPROVED Instagram posts scheduled for 2026-07-15 are due to publish.
